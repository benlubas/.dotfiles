...
-- binds terminal specific? or if I open another nvim will they be coppied. I kinda don't want them 
-- to get coppied over, that would be a little annoying.
-- Okay, I don't think it likes having two nvim instanses open at the same time... 
