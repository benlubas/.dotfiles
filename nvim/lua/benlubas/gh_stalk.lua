-- Stalk someone's github activity
-- taken from https://github.com/tamton-aquib/stuff.nvim/blob/ff1a5b7f80cf4ceebde130772788bcffca203673/lua/stalk.lua
local S = {}

local pad = function(str, pad)
  return " " .. str .. (" "):rep(pad - #str)
end
